...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($documento)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            echo "<div class='alert alert-success'>Este número de documento ya es comisionista.</div>";
        } else {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='alert alert-danger'>Este número de documento no ha hecho una petición.</div>";
            }
        }
    }
}
