...
while ($row = mysqli_fetch_array($result)) { ?>
    <div class="modal fade" id="verinfo<?php echo $row['SolicitudID'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Información de la solicitud número <?php echo $row['SolicitudID'] ?></h1>
                ...
                <div class="modal-body">
                    <div class="row mb-4 justify-content-center">
                        <div class="col">
                            ...
                            <div><?php echo $row['TipoDocumento'] ?></div>
                        </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <b>Apellido: </b><?php echo $row['Apellidos'] ?>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
