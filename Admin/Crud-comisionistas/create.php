                ...
                <form action="" id="FormCrateComisionista" method="post">
                    ...
                    <div class="mb-3 row justify-content-md-center">
                        <div class="col">
                            ...
                            <input type="number" maxlength="20" class="form-control" id="documento" name="UsuarioID" value="">
                        </div>
                    </div>
                    <div class="mb-3 row justify-content-md-center">
                        <div class="col">
                            <label for="recipient-name" class="col-form-label">Nombre:</label>
                            <input type="text" maxlength="50" class="form-control" id="recipient-name" name="Nombre">
                        </div>
                        <div class="col">
                            <label for="message-text" class="col-form-label">Apellido:</label>
                            <input type="text" maxlength="50" class="form-control" id="message-text" name="Apellido">
                        </div>
                    </div>
                    <div class="mb-3 row justify-content-md-center">
                        <div class="col">
                            <label for="edad" class="col-form-label">Edad:</label>
                            <input type="number" maxlength="3" class="form-control" id="edad" name="Edad">
                        </div>
                        <div class="col">
                    ...
                    <div class="mb-3 row justify-content-md-center">
                        <div class="col">
                            ...
                            <input type="text" maxlength="100" class="form-control" id="correo" name="Correo">
                        </div>
                        <div class="col">
                    ...
                    <div class="mb-3 row justify-content-md-center">
                        <div class="col">
                            ...
                            <input type="text" maxlength="70" class="form-control" id="ciudad" name="Ciudad">
                        </div>
                        <div class="col">
